package net.runelite.client.plugins.microbot.pumstersreflection.overlay;
...
public class OverlayUtility
{
	...
	{
		Widget widget = client.getWidget(getPrayerWidgetId(prayer));

		if (widget == null || client.getVarcIntValue(VarClientInt.INVENTORY_TAB) != InterfaceID.PRAYER)
		{
			return null;
		}
